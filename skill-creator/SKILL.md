...
This skill provides guidance for creating effective Agent Skills that work across different AI agents including GitHub Copilot, Claude, and other AI assistants.
...
To create an effective skill, clearly understand concrete examples of how the skill will be used. This understanding can come from direct user examples or generated examples that are validated with user feedback.
...
- `description`: This is the primary triggering mechanism for your skill (1-1024 characters)
