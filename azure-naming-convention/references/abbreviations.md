...
Complete abbreviation table from the [Microsoft Cloud Adoption Framework](https://learn.microsoft.com/en-us/azure/cloud-adoption-framework/ready/azure-best-practices/resource-abbreviations).

Look up abbreviations by category or grep for the resource type name.
...
| Azure Policy definition | *descriptive name* |
